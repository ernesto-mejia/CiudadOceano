...
@section('content')
    ...
    <div id="Article"  class="col-12">
        ...
        <div class="row " style="height: 94%">
            ...
            <!-- iMAGEN DESTACADA -->
                <div  class="col-6 justify-content-center align-items-center h-100">
                    <img src="{{ url('/multimedia/'.$post->file_path.'/'.$post->slug.'/'.$post->file) }}" class="d-block imagen_noticia w-100 h-100">
