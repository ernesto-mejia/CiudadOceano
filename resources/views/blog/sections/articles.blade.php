...
@section('content')
    ...
    <div id="Articles" class="row h-100 justify-content-center align-content-center" >
        @if ($countArt == 0)
        ...
        @else
            @foreach ($articles as $article)
                ...
                <div class="col-md-4 col-6" >
                    ...
                    <div   class="cont-card-event" style="background-color: #007196;    height: 250px;     padding: 0% !important;">
